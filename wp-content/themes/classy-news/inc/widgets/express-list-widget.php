<?php
if ( ! class_exists( 'Classy_News_Express_List_Widget' ) ) {
	/**
	 * Adds Classy News Express List Widget.
	 */
	class Classy_News_Express_List_Widget extends WP_Widget {
		...
		public function __construct() {
			$express_list_widget = array(
				...
				'description' => __( 'Retrive Express List Widgets', 'classy-news' ),
			);
			parent::__construct(
				'classy_news_express_list_widget',
				__( 'Adore Widget: Express List Widget', 'classy-news' ),
				$express_list_widget
			);
		}
		...
		public function widget( $args, $instance ) {
			...
			$read_more_button_label   = ( ! empty( $instance['read_more_button_label'] ) ) ? $instance['read_more_button_label'] : __( 'Read More', 'classy-news' );
			...
			if ( ! empty( $express_list_title || $viewall_button_label ) ) {
				...
				<div class="widget-header">
					<?php echo $args['before_title'] . esc_html( $express_list_title ) . $args['after_title']; ?>
		...
		public function form( $instance ) {
			...
			$read_more_button_label   = isset( $instance['read_more_button_label'] ) ? $instance['read_more_button_label'] : __( 'Read More', 'classy-news' );
			$express_list_post_offset = isset( $instance['offset'] ) ? absint( $instance['offset'] ) : '';
			$express_list_category    = isset( $instance['category'] ) ? absint( $instance['category'] ) : '';
			?>
			<p>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'read_more_button_label' ) ); ?>"><?php esc_html_e( 'Read More Button Label:', 'classy-news' ); ?></label>
