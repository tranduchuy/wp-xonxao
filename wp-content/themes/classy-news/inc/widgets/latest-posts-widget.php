<?php
if ( ! class_exists( 'Classy_News_Latest_Posts_Widget' ) ) {
	/**
	 * Adds Classy News Latest Posts Widget.
	 */
	class Classy_News_Latest_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			$latest_posts_widget = array(
				...
				'description' => __( 'Retrive Latest Posts Widgets', 'classy-news' ),
			);
			parent::__construct(
				'classy_news_latest_posts_widget',
				__( 'Adore Widget: Latest Posts Widget', 'classy-news' ),
				$latest_posts_widget
			);
		}
			...
			public function widget( $args, $instance ) {
				...
				if ( ! empty( $latest_posts_title || $viewall_button_label ) ) {
					...
					<div class="widget-header">
						<?php echo $args['before_title'] . esc_html( $latest_posts_title ) . $args['after_title']; ?>
